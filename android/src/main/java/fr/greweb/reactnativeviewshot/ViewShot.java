...
public class ViewShot implements UIBlock {
    ...
    public void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
        ...
        try {
            ...
            String nameClass = view.getClass().getName();

            if (nameClass.equals("com.oney.WebRTCModule.WebRTCView")) {
                final WebRTCView webrtcView = (WebRTCView) view;
                final SurfaceViewRenderer sw = (SurfaceViewRenderer) webrtcView.getSurfaceView();

                String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
                File file = new File(Environment.getExternalStorageDirectory() + File.separator + "DCIM/" + timeStamp + ".png");

                sw.setPromise(this.promise);
                sw.saveFrame(this.extension, this.output);
